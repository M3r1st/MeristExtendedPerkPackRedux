class X2DLCInfo_MeristExtendedPerkPackRedux extends X2DownloadableContentInfo;
...
var config(GameData_SoldierSkills) array<ItemTech> GremlinTiers;
var config(GameData_SoldierSkills) array<ItemTech> WeaponTiers;
var config(GameData_SoldierSkills) array<ItemTech> ArmorTiers;
var config(GameData_SoldierSkills) array<name> ExplosiveDamageTypes;
var config(GameData_SoldierSkills) array<name> SmokeGrenades;
var array<name> CBAC_AllowedTypes;

var privatewrite config array<name> CachedActiveMods;

var config bool bLog;
var config bool bNoColors;
...
static event OnPostTemplatesCreated()
{
    ...
    `LOG("OnPostTemplatesCreated", default.bLog, 'MeristExtendedPerkPackRedux');
...
static function PatchAbilityForBotnet(X2AbilityTemplate Template)
{
    ...
    {
        `LOG(Template.DataName, default.bLog, GetFuncName());
        AddEffectToAbility(Template, class'X2Ability_ExtendedPerkPack'.static.BotnetEffect());
    }
}
...
static function PatchAbilityForCoordinateFire(X2AbilityTemplate Template)
{
    if (Template != none)
    {
        if (Template.AdditionalAbilities.Find('F_CoordinateFire_Attack') == INDEX_NONE)
        {
            `LOG(Template.DataName, default.bLog, GetFuncName());
...
static function bool AbilityTagExpandHandler_CH(string InString, out string OutString, Object ParseObj, Object StrategyParseOb, XComGameState GameState)
{
    switch (InString)
    {
        ...
        case "F_SelfCharges":
            ...
            return true;
        case "F_SelfAmmoCost":
            OutString = GetSelfAmmoCost(ParseObj, StrategyParseOb, GameState);
            return true;
        case "F_FreeAction":
        ...
        case "F_PierceTheVeil_AimBonus":
        case "F_PierceTheVeil_CritBonus":
        case "F_PierceTheVeil_DamageBonus":
        case "F_PierceTheVeil_PierceBonus":
        case "F_PierceTheVeil_DebuffDuration":
        case "F_PierceTheVeil_AsTargetAimBonus":
        case "F_PierceTheVeil_AsTargetCritBonus":
        case "F_PierceTheVeil_AsTargetDamageBonus":
        case "F_PierceTheVeil_ArmorPenalty":
        ...
        case "F_Unload_ToHitMod":
            OutString = ColorText_Gold(int(Abs(`GetConfigInt(InString))));
            return true;
...
static private function string GetSelfAmmoCost(Object ParseObj, Object StrategyParseObj, XComGameState GameState)
{
    local X2AbilityTemplate     AbilityTemplate;
    ...
    if (AbilityTemplate != none)
    {
        foreach AbilityTemplate.AbilityCosts(Cost)
        {
            ...
            if (AmmoCost != none)
            {
                return ColorText_Gold(AmmoCost.iAmmo);
            }
        }
    }
