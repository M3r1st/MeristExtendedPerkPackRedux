...
function int ModifyDamageFromDestructible(
    XComGameState_Destructible DestructibleState,
    int IncomingDamage,
    XComGameState_Unit TargetUnit,
    XComGameState_Effect EffectState)
{
...
simulated function bool IsDamageExplosive(XComGameState_Ability AbilityState, X2Effect_ApplyWeaponDamage WeaponDamageEffect)
{
    ...
    ExplosiveDamageTypes = class'X2DLCInfo_WOTC_ExtendedPerkPack'.default.ExplosiveDamageTypes;
