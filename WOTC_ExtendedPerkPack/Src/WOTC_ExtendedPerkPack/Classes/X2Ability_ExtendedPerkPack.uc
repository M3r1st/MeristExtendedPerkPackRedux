...
static function X2AbilityTemplate Maim()
{
    ...
    Effect.SetDisplayInfo(ePerkBuff_Penalty, Template.LocFriendlyName, Template.LocLongDescription, Template.IconImage,,, Template.AbilitySourceName);
...
static function X2AbilityTemplate Preservation()
{
    ...
    DefenseEffect.SetDisplayInfo(ePerkBuff_Bonus, Template.LocFriendlyName, Template.LocLongDescription, Template.IconImage,,, Template.AbilitySourceName);
...
static function X2AbilityTemplate CallForFire()
{
    ...
    RadiusMultiTarget.fTargetRadius = `TILESTOMETERS(`GetConfigInt("F_CallForFire_Radius"));
    RadiusMultiTarget.bIgnoreBlockingCover = true;
    Template.AbilityMultiTargetStyle = RadiusMultiTarget;

    PassiveRadius = new class'X2AbilityPassiveAOE_WeaponRadius';
    PassiveRadius.fTargetRadius = `TILESTOMETERS(`GetConfigInt("F_CallForFire_Radius"));
...
static function X2AbilityTemplate WellProtected()
{
    ...
    return Passive('F_WellProtected', "img:///UILibrary_FavidsPerkPack.Perk_Ph_WellProtected", `GetConfigBool("F_WellProtected_bAWC"), true, true);
}
...
static function X2AbilityTemplate Triage()
{
    ...
    RadiusMultiTarget = new class'X2AbilityMultiTarget_Radius';
    RadiusMultiTarget.fTargetRadius = `TILESTOMETERS(`GetConfigInt("F_Triage_Radius"));
    RadiusMultiTarget.bIgnoreBlockingCover = true;
    Template.AbilityMultiTargetStyle = RadiusMultiTarget;

    PassiveRadius = new class'X2AbilityPassiveAOE_WeaponRadius';
    PassiveRadius.fTargetRadius = `TILESTOMETERS(`GetConfigInt("F_Triage_Radius"));
    Template.AbilityPassiveAOEStyle = PassiveRadius;
...
static function X2AbilityTemplate Renewal()
{
    ...
    RadiusMultiTarget = new class'X2AbilityMultiTarget_Radius';
    RadiusMultiTarget.fTargetRadius = `TILESTOMETERS(`GetConfigInt("F_Renewal_Radius"));
    RadiusMultiTarget.bIgnoreBlockingCover = true;
    Template.AbilityMultiTargetStyle = RadiusMultiTarget;
...
static function X2AbilityTemplate Rally()
{
    ...
    RadiusMultiTarget = new class'X2AbilityMultiTarget_Radius';
    RadiusMultiTarget.fTargetRadius = `TILESTOMETERS(`GetConfigInt("F_Rally_Radius"));
    RadiusMultiTarget.bIgnoreBlockingCover = true;
    RadiusMultiTarget.bExcludeSelfAsTargetIfWithinRadius = true;
    Template.AbilityMultiTargetStyle = RadiusMultiTarget;

    PassiveRadius = new class'X2AbilityPassiveAOE_WeaponRadius';
    PassiveRadius.fTargetRadius = `TILESTOMETERS(`GetConfigInt("F_Rally_Radius"));
    Template.AbilityPassiveAOEStyle = PassiveRadius;
...
static function X2Effect ShieldTraumaEffect()
{
    ...
    AbilityCondition = new class'X2Condition_AbilityProperty';
    AbilityCondition.OwnerHasSoldierAbilities.AddItem('F_ShieldTrauma');
...
static function X2AbilityTemplate GuardPassive()
{
    ...
    Template = Passive('F_Guard_Passive', "img:///UILibrary_XPACK_Common.PerkIcons.UIPerk_parry", false, true, true);
...
static function X2AbilityTemplate IntimidateTrigger()
{
    ...
    Template = SelfTargetActivated('F_Intimidate_Trigger', "img:///UILibrary_XPerkIconPack.UIPerk_pistol_circle", false);
...
static function X2AbilityTemplate MindBlast()
{
    ...
    Template.CustomFireAnim = 'F_HL_Psi_ProjectileMedium';
...
static function X2AbilityTemplate MindBlastAnims()
{
    ...
    Template = Passive('M31_Psi_Animations', "img:///UILibrary_FavidsPerkPack.UIPerk_MindBlast", false, false, true);
    ...
    AnimSetEffect.AddAnimSetWithPath("???.Anims.???");
